...
export type CacheListenerOptions =
    ...
    | { type: "refetch"; silent: boolean; onInvalidate?: () => void };
...
export type CacheKey = [CacheKeyEntity, ...(string | number | undefined | null)[]];

/**
 * type for a value within the cache
 */
export type CacheAPIValue<T extends CacheKey> =
    T extends [infer A, ...unknown[]] ?
