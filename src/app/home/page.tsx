            ...
            <div className="flex flex-col gap-8 text-center max-w-3xl">
                ...
                <div className="flex flex-col gap-4">
                    <p>
                        ...
                        application reimagines conventional architectures
                        through a strictly typed{" "}
                        <mark>
                            <b>state</b>
                        </mark>{" "}
                        ...
                        flow, designed to be predictable, efficient, and free
                        from unnecessary rendering.
                    </p>
                    <p>
                        A custom{" "}
                        <mark>
                        ...
                        to deliver a fast, consistent frontend, prioritizing
