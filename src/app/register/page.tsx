			...
			{status && status.isLoggedIn === true ? (
				...
				<>
					<div className="flex flex-col gap-1 text-center max-w-lg">
						<h1>Signing up</h1>
						<p>
							Create an account to get started. Your information is securely
							stored and used only to provide access to the platform and its
							features. Your account ensures protected, reliable access across
							sessions.
						</p>
					</div>
					<AuthenticationForm
