...
export const Role = ({ data }: Props) => {
    const roleStyle = useMemo((): { element: React.ReactNode, tooltip: string } => {
                    ...
                    <div className="box p-1! px-2! items-center! outline-1 outline-[#8a8b91]">
                        <div className="flex gap-1">
                            <Image
                                ...
                                src="/account.svg"
                            />
                            <span className="text-foreground-5!">User</span>
                        </div>
                    </div>
                    ...
                    <div className="box p-1! px-2! items-center! outline-1 outline-[#97a2da]">
                        <div className="flex gap-1">
                            <Image
                                ...
                                src="/security.svg"
                            />
                            <span className="text-foreground-5!">Admin</span>
                        </div>
                    </div>
                    ...
                    <div className="box p-1! px-2! items-center! outline-1 outline-[#cd5151]">
                        <div className="flex gap-1">
                            <Image
                                ...
                                src="/settings.svg"
                            />
                            <span className="text-foreground-5!">OP</span>
                        </div>
                    </div>
