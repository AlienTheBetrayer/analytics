...
export const SendForm = forwardRef<SendFormHandle, Props>(function SendFormComponent(
            ...
            >
                ...
                <li className="flex flex-col gap-2 items-center">
                    ...
                    <Input
                        ...
                        required
                        maxLength={1024}
                        className="grow rounded-2xl! min-h-64 max-h-128 not-hover:bg-bg-1!"
                        as="textarea"
                        id="message"
                ...
                <li className="flex flex-col items-center">
                    <ul className="grid grid-cols-2 w-full lg:max-w-sm gap-2">
                        <li>
                            <Button
                        ...
                        <li>
                            ...
                            >
                                ...
                                <Image
                                    ...
                                    width={16}
                                    height={16}
                                    src={type === "send" ? "/send.svg" : "/pencil.svg"}
                                />
                                <mark>{type === "send" ? "Send" : "Edit"}</mark>
                            </Button>
                        </li>
                    </ul>
                </li>
