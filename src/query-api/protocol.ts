...
import { CacheAPIProtocolOther } from "@/query-api/protocol/other";
 ...
 */
export type CacheAPIFunctions<T> = Record<keyof T, (args: unknown[]) => Promise<CacheValue>>;
